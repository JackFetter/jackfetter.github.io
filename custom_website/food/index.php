...
<body>
	<div class="wrapper-food">
		...
		$selectedb = array_rand($breakfast);
		$selectedld = array_rand($lunch_dinner);
		date_default_timezone_set('Australia/Sydney');
		if (date('H') < 5) {
			echo $lunch_dinner[$selectedld];
			echo "<br />for a<br />late-night snack.";
		}
		elseif (date('H') < 10) {
			echo $breakfast[$selectedb];
			echo "<br />for breakfast.";
		}
		elseif (date('H') < 16) {
	       	echo $lunch_dinner[$selectedld];
			echo "<br />for lunch.";
